...
##Plot Data
#Plot1: the transparent background color is chosen to match the example png files in the repo
png(file="plot1.png", bg="transparent", width = 480, height = 480) 
with(el_data, hist(Global_active_power, col = "red", main = "Gloval Active Power", xlab = "Global Active Power (kilowatts)"))
dev.off()
